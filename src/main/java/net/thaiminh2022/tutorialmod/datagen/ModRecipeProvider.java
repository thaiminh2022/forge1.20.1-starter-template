...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    private static final List<ItemLike> SAPPHIRE_SMELLABLE = List.of(
...
//        oreBlasting(pWriter, SAPPHIRE_SMELLABLE, RecipeCategory.MISC, ModItems.SAPPHIRE.get(), .25f, 100, "sapphire");
//        oreSmelting(pWriter, SAPPHIRE_SMELLABLE, RecipeCategory.MISC, ModItems.SAPPHIRE.get(), .25f, 200, "sapphire");
//
